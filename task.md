...
- `[x]` 10. Verification: typecheck ✅, lint 0 errors (28 warnings) ✅, tests 86/86 ✅. Browser-verified computed styles — publisher `Masuk` `rgb(182,71,23)`, all CTAs `rgb(181,132,24)`, all radii `12px`, dead tokens report gone; reader `--amber`/`--gold` both `#b58418`, CTA 12px. Zero horizontal overflow at 1440/1280/1024/768/390 on both surfaces; container still 1128px on both.
