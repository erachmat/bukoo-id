    ...
    <section className="testi-section">
      ...
      <div className="testi-grid">
        ...
        <div className="testi-card" style={{ borderColor: 'rgba(201,149,42,.25)' }}>
          <div className="testi-quote-icon">&quot;</div>
          <p className="testi-text">Sebagai mahasiswa, dulu saya selalu kesulitan akses buku akademik yang mahal. Dengan BUKOO tier Baca seharga Rp 29.900, saya bisa baca buku-buku yang biasanya ratusan ribu. Fitur komunitas juga seru, bisa diskusi bareng pembaca lain!</p>
          <div className="testi-author">
