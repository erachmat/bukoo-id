import { PrismaClient, Provider, SubscriptionTier, ShelfType } from '@prisma/client';
...
async function main() {
  ...
  const books = [
    ...
    },
    {
      ...
      readTimeMinutes: 360,
      isPublished: true,
      subscriptionRequired: SubscriptionTier.PERSONAL,
      isAvailableOffline: true,
    },
    {
      id: 'book_saman',
  ...
  const users = [
    {
      ...
      passwordHash: '$2b$12$K1r.mZ7iGqM1sL2rS3tU.uL1p4/q4m5n7o8p9q0r1s2t3u4v5w6x7',
    ...
    },
    {
      ...
      passwordHash: '$2b$12$L2s.nZ8jHqN2tM3sT4uV.vM2q5/r5n6o7p8q9r0s1t2u3v4w5x6y8',
      provider: Provider.EMAIL,
      onboardingCompleted: true,
      agreeToS: true,
    },
